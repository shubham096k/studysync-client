...
export default function Navbar() {
    ...
    const getButtonStyles = (path) => ({
        backgroundColor: location.pathname.startsWith(path) ? 'rgba(255, 255, 255, 0.2)' : 'transparent',
        borderBottom: location.pathname.startsWith(path) ? '2px solid white' : '2px solid transparent',
        borderRadius: 0,
        '&:hover': {
